...
miot_arrival_rate = 0 
arrival_rates = [20] #[30,25,20,15,10,5,3] #
...
avble_edge_size = 10 #5
avble_central_size = 10 #5
avble_bw_size = 10 #5

pct_inst_embb_size = 10 #5 #porcentaje de slices instanciados de tipo embb
pct_inst_urllc_size = 10 #5
pct_inst_miot_size = 10 #5
...
def func_twindow(c,evt):
    ...
    sim.granted_req_list = filtro(sim.window_req_list, a) #se filtra la lista de reqs dependiendo de la accion
...
# ▄███▄ ▀▀  ▄████▄███▄   ▄████▄████▄███▄    ██ 
    ...
    for m in arrival_rates:
        ...
        for i in range(repetitions):
            ...
            #f = open("sara_"+str(m)+"_16BA_3de10sta_30act_160epi.txt","w+")
            f = open("deepsara_"+str(m)+"_16BA_9de10sta_30act_replaystartsize500_anneal_rate1-5000_160epi.txt","w+")
